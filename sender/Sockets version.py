...
async def receive_and_process_video():
    uri = "ws://192.168.165.107:8765"  # Replace with Pi's IP
    async with websockets.connect(uri) as websocket:
        while True:
            try:
                # Receive video data from Pi
                ...
                # Calculate and send pose data to Blender
                ...
                cv2.imshow('Pose Tracking from Pi', frame)
...
try:
    asyncio.get_event_loop().run_until_complete(receive_and_process_video())
finally:
    sock.close()
